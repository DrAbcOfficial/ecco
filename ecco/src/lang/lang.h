...
void ClientPrintfTranslation(edict_t* target, EccoMetaUtility::ClientPrintTarget hud, std::string text_key);
template <typename... Strings>
void ClientPrintfTranslation(edict_t* target, EccoMetaUtility::ClientPrintTarget hud, std::string text_key, Strings&&... args) {
